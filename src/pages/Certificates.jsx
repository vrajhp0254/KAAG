  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1733236954585-298e01830b4e?q=80&w=1032&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-40"></div>
        <div className="relative text-center px-4">
          <h1 className="text-3xl sm:text-5xl font-bold mb-4">Certificates</h1>
          <p className="text-lg sm:text-xl">
            Our certifications demonstrate our commitment to quality and compliance
          </p>
        </div>
      </section>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg w-full max-w-4xl h-[90vh] flex flex-col">
            <div className="flex justify-between items-center p-2 sm:p-4 border-b">
              <h3 className="text-lg sm:text-xl font-semibold truncate pr-2">{selectedCertificate.title}</h3>
              <button
            ...
            <div className="flex-1 overflow-hidden">
              <iframe
                src={`${selectedCertificate.pdfUrl}#toolbar=0&view=FitH`}
